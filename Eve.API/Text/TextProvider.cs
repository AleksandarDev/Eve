...
namespace Eve.API.Text {
	...
	public class TextProvider : ProviderBase<TextProvider> {
		...
		/// call to simulate key DOWN and UP for given key
		/// </summary>
		...
		/// <summary>
		/// Calls WindowsInput.InputSimulator method that uses Win32 SendInput 
		/// call to simulate key down for given key
		/// </summary>
		...
		/// <summary>
		/// Calls WindowsInput.InputSimulator method that uses Win32 SendInput 
		/// call to simulate multiple modifiers and multiple keys like strokes 
		/// eg. CTRL-K-C, SHIFT-C, etc.
		/// </summary>
		...
		/// This enum can be directly mapped to WindowsInput.VirtualKeyCode enum
		/// </summary>
